...
#     long_description_content_type="text/markdown",
    url="https://github.com/bkdwei/kdYoudaoVoiceAssistant",
    license="GPLv3+",
    platforms=["any"],
...
#   see  https://pypi.org/classifiers/
    ...
    entry_points={
        'gui_scripts': [
            'kdYoudaoVoiceAssistant=kdYoudaoVoiceAssistant.kdYoudaoVoiceAssistant:main'
        ],    
    },
    cmdclass={
        'install': install_cmd,
